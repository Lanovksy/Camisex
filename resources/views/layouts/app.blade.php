...
<head>
    ...
    <title>{{ config('app.name', 'Camisex') }}</title>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    @if(Auth::user()->email == 'admin@admin.com')
                                        ...
                                        <a class="dropdown-item" href="condons">Camisinhas</a>
                                        <a class="dropdown-item" href="all_orders">Pedidos</a>
